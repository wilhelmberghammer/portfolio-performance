...
from .views import portfolio_list, PositionCreateView, PositionEditView, PositionDeleteView, PositionDetailView 
...
urlpatterns = [
	...
	path('<int:pk>/', PositionDetailView, name='position-detail'),
